        ...
        public async Task<IActionResult> Login(LoginViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (await _loginService.ValidateCredentials(user, model.Password))
                {
                    ...
                    if (model.RememberMe)
                    {
                        props = new Microsoft.AspNetCore.Http.Authentication.AuthenticationProperties
                        {
                            IsPersistent = true,
        ...
        public async Task<IActionResult> Logout(LogoutViewModel model)
        {
            ...
            if (idp != null && idp != IdentityServerConstants.LocalIdentityProvider)
            {
                ...
                try
                {
                    ...
                    await HttpContext.Authentication.SignOutAsync(idp, new Microsoft.AspNetCore.Http.Authentication.AuthenticationProperties { RedirectUri = url });
                }
                catch(Exception ex)
                {
            ...
            await HttpContext.Authentication.SignOutAsync("token");
